/* ============================================
   Valentine's Day — Duck & Ankylosaurus
...
(function () {
  ...
  document.addEventListener('mousemove', function (e) {
    ...
    var duck = document.getElementById('duck-character');
    var anky = document.getElementById('ankylosaurus-character');
    var pulse = document.getElementById('love-pulse');

    if (duck) duck.style.transform = 'translateX(' + (mx * -6) + 'px) translateY(' + (my * -4) + 'px)';
...
let duckClicks = 0;
const duck = document.getElementById('duck-character');
